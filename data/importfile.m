function keys = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   KEY = IMPORTFILE(FILENAME) Reads data from text file FILENAME for the
%   default selection.
%
%   KEY = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   key = importfile('key.txt', 1, 1132);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2016/11/18 19:03:16
